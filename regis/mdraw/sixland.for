...
C      dump in landscape mode and enlarge it to fill the page. 
C      !! IMPORTANT !!    you must have extra RAM cartridge for the ln03.
C      If you do not, comment out the landscape and enlarge statements below.
C      Your print will then come out smaller than the actual size on the screen.

	    File_Rec = 1
        landscape = char(27)//char(91)//char(49)//char(32)//char(74)
        Write (1'File_Rec) landscape

	   File_Rec = File_Rec + 1
       enlarge = char(144)//char(48)//char(59)//char(50)
     + //char(59)//char(51)//char(113)//char(51)
...
C        File_Rec = 1
C        escape = char(27)//char(80)//char(49)//char(113)
C        Write (1'File_Rec) escape
